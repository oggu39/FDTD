...
E_reflect = np.loadtxt('G:/C/FDTD/exported_data/reflected_field.txt');
t = np.loadtxt('G:/C/FDTD/exported_data/t_data.txt');
E_transmit = np.loadtxt('G:/C/FDTD/exported_data/transmitted_field.txt');
E_src = np.loadtxt('G:/C/FDTD/exported_data/source_field.txt');
