...
int main(){
	...
	char *PATH_time = "exported_data\\t_data.txt";
	//char *PATH_z = "G:\\c\\FDTD\\exported_data\\z_data.txt";	
	char *PATH_reflection = "exported_data\\reflected_field.txt";
	char *PATH_transmission = "exported_data\\transmitted_field.txt";
	char *PATH_source = "exported_data\\source_field.txt";
